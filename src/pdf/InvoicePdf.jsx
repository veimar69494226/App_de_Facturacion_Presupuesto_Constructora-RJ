...
const styles = StyleSheet.create({
  page: {
    ...
    paddingLeft: 28,
    paddingRight: 28,
    paddingBottom: 90, // espacio para que el footer NO se pise con el contenido
    fontSize: 10,
...
export default function InvoicePdf({ doc }) {
      ...
      <Page size="Letter" style={styles.page} wrap>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.box}>
            ...
            <Text>Nombre: {doc.cliente?.nombre || "-"}</Text>
            <Text>NIF: {doc.cliente?.nif || "-"}</Text>
            <Text>Dirección: {doc.cliente?.direccion || "-"}</Text>
          </View>
